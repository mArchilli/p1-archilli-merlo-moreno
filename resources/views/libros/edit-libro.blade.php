...
<x-layout>
    ...
    <h1 class="mb-3 mosta">Editar libro</h1>
    ...
    <form action="{{ route('libro.edit.process', ['id' => $libro->id]) }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="mb-3">
                    <label for="editorial" class="form-label">ISBN</label>
            ...
            <div class="col-12 mb-3">
                ...
                <textarea id="descripcion" name="descripcion" class="form-control">{{$libro->descripcion}}</textarea>
                @error('descripcion')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>  
